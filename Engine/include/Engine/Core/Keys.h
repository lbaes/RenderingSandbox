...
namespace Eng
{
	...
	constexpr int KeyToCode(KeyState state)
	{
		return static_cast<int>(state);
	}

	constexpr int KeyToCode(Modifiers modifiers)
	{
		return static_cast<int>(modifiers);
	}

	constexpr int KeyToCode(MouseButton mouseButton)
	{
		return static_cast<int>(mouseButton);
	}

	constexpr int KeyToCode(Keys key)
	{
