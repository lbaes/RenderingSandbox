...
public:
    ...
    void OnStart() override {
        ...
        unsigned int effects = ShaderEffects::TEXTURES | ShaderEffects::AMBIENT_LIGHT | ShaderEffects::NORMAL_MAP |
                               ShaderEffects::SPECULAR_MAP;
        unsigned int effects_simple =
                ShaderEffects::TEXTURES | ShaderEffects::AMBIENT_LIGHT | ShaderEffects::SPECULAR_MAP;
        ...
        // Render target
        unsigned int attachments = GPURenderTargetAttachments::COLOR |
                                   GPURenderTargetAttachments::DEPTH |
                                   GPURenderTargetAttachments::STENCIL;
        screenTarget = renderDevice->CreateRenderTarget(window->GetPixelWidth(),
